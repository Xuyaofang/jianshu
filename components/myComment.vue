            ...
            <div class="comment">
                ...
                <div class="comment-wrap">
                    ...
                    <div class="tool-group">
                        <a class="like-btn" @click="isZan=!isZan" :class="[isZan?'zan':'']">
                          <span>{{isZan?zan+1:zan}}人赞 </span>
                        </a>
...
.comment-list .comment .comment-wrap .zan::before {
  animation: zan 0.6s steps(20) forwards;
}
...
.comment-list .sub-comment-list form.new-comment {
  margin-left: 0;
}
</style>
